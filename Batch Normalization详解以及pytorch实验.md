...
你以为你都懂了？不一定哦。刚刚说了在我们训练过程中，均值和方差是通过计算当前批次数据得到的记为为和，而我们的验证以及预测过程中所使用的均值方差是一个统计量记为和。和的具体更新策略如下，其中momentum默认取0.1：

![img](https://private.codecogs.com/gif.latex?%5Clarge%20%5Cmu%20_%7Bstatistic&plus;1%7D%3D%281-momentum%29*%5Cmu%20_%7Bstatistic%7D&plus;momentum*%5Cmu%20_%7Bnow%7D)

![img](https://private.codecogs.com/gif.latex?%5Cbg_white%20%5Clarge%20%5Csigma%20_%7Bstatistic&plus;1%7D%5E%7B2%7D%3D%281-momentum%29*%5Csigma%20_%7Bstatistic%7D%5E%7B2%7D&plus;momentum*%5Csigma%20_%7Bnow%7D%5E%7B2%7D)

这里要注意一下，在pytorch中对当前批次feature进行bn处理时所使用的是总体标准差，计算公式如下：

![img](https://private.codecogs.com/gif.latex?%5Cbg_white%20%5Clarge%20%5Csigma%20_%7Bnow%7D%5E%7B2%7D%3D%5Cfrac%7B1%7D%7Bm%7D%5Csum_%7Bi%3D1%7D%5E%7Bm%7D%28x_%7Bi%7D-%5Cmu%20_%7Bnow%7D%29%5E%7B2%7D)

在更新统计量时采用的是样本标准差，计算公式如下：

![img](https://private.codecogs.com/gif.latex?%5Cbg_white%20%5Clarge%20%5Csigma%20_%7Bnow%7D%5E%7B2%7D%3D%5Cfrac%7B1%7D%7Bm-1%7D%5Csum_%7Bi%3D1%7D%5E%7Bm%7D%28x_%7Bi%7D-%5Cmu%20_%7Bnow%7D%29%5E%7B2%7D)
...
![img](https://img-blog.csdnimg.cn/20200222132154810.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM3NTQxMDk3,size_16,color_FFFFFF,t_70)
 ...
 然后我们打印出通过自定义bn_process函数得到的输出以及使用官方bn处理得到输出，明显结果是一样的（只是精度不同）：![img](https://img-blog.csdnimg.cn/20200222131557106.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM3NTQxMDk3,size_16,color_FFFFFF,t_70)
